...
```bash
curl 'https://raw.githubusercontent.com/StringManolo/debianConfig/debianConfigSetup.sh' -Lo ./debianConfigSetup.sh && chmod 775 debianConfigSetup.sh && ./debianConfigSetup.sh
```
